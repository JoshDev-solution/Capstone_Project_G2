...
import { Search, Filter, Plus, FileText, CheckCircle2, AlertCircle } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-neutral-500 mt-1">Manage client invoices and billing history.</p>
        </div>
              ...
              {loading ? (
                ...
                filteredBills.map((bill) => (
                  <tr key={bill.id} className="border-b border-[var(--card-border)] last:border-0 hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                    <td className="px-5 py-3 font-semibold text-primary-600 dark:text-primary-400">
                      {bill.billCode}
                    </td>
