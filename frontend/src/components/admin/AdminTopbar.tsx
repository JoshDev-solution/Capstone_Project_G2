...
import { Bell, Search, Sun, Moon, PawPrint, ChevronDown, Settings, LogOut, User, Menu } from "lucide-react";
...
export default function AdminTopbar({ sidebarCollapsed, onMenuClick, title = "Dashboard" }: AdminTopbarProps) {
