...
export default function VetTopbar({ sidebarCollapsed, title = "Clinical Dashboard" }: VetTopbarProps) {
  ...
  const notifications = [
    { id: 1, text: "Appointment APT-1002 starts in 15 mins", time: "2m ago", unread: true },
    { id: 2, text: "Lab results ready for Max (Golden Retriever)", time: "1h ago", unread: true },
    { id: 3, text: "Low stock: Rabies Vaccine (3 left)", time: "2h ago", unread: false },
  ];
          ...
          {notifOpen && (
            <div className="absolute right-0 top-12 w-80 card shadow-xl z-50 overflow-hidden">
              ...
              <div className="px-4 py-2.5 text-center">
                <button className="text-xs text-primary-500 font-medium hover:underline">View all alerts</button>
              </div>
            </div>
          )}
        </div>
